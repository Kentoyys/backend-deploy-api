...
models = {
    "model": load_model(os.path.join(base_dir, "models", "dyscalculia_arithmetic.joblib")),
    "scaler": load_model(os.path.join(base_dir, "models", "arithmetic_scaler.pkl")),
    "op_encoder": load_model(os.path.join(base_dir, "models", "arithmetic_op_encoder.joblib"))
}
